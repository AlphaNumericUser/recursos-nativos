  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    ref.listen(adRewardedProvider, (previous, next) {
     ...
     if( adRewardedAsync.isLoading ){
      return const Scaffold(body: Center(child: Text('Cargando anuncio', style: TextStyle(fontSize: 20))));
     }
    ...
    return Scaffold(
      ...
      body: Center(
        child: Text('Puntos actuales: $adPoints', style: const TextStyle(fontSize: 20)),
      ),
    );
  }
}