    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            Badge(
              alignment: Alignment.lerp(Alignment.topRight, Alignment.bottomRight, 0.130),
              label: Text('$badgeCounter'),
              child: Text('$badgeCounter', style: const TextStyle(fontSize: 160)),
            ),
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          ...
          AppBadgePlugin.updateBadgeCout(badgeCounter + 1);
        },
